...
# diagnostics
curl --fail --show-error -o pages/reference/supervisor-diagnostics.md -L https://github.com/balena-io-modules/device-diagnostics/raw/master/supervisor-state.md &
